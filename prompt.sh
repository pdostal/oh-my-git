...
if [ -n "${BASH_VERSION}" ]; then
    ...
    function custom_build_prompt {
        ...
        local black_on_white="${white}${background_black}"
        local yellow_on_white="${yellow}${background_black}"
        local red_on_white="${red}${background_black}"
        local red_on_black="${red}${background_black}"
        local black_on_red="${white}${background_black}"
        local white_on_red="${white}${background_black}"
        local yellow_on_red="${yellow}${background_black}"
